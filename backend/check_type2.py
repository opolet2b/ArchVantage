...
cur = conn.cursor()
cur.execute("SELECT bpmn_json FROM workflow_templates WHERE id=(SELECT template_id FROM workflow_instances WHERE id='10dffb31-8f25-4633-a2e2-24026c752e68')")
row = cur.fetchone()
